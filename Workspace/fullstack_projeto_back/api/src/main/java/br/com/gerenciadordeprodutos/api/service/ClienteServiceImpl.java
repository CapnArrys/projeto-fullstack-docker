...
public class ClienteServiceImpl implements ClienteService {
    ...
    public ClienteCriadoResponse criarCliente(CriarClienteRequest criarClienteRequest) {
        ...
        // por ser um record, não é necessário utilizar .getNome ou getCpf, acessa diretamente
        ...
        return new ClienteCriadoResponse("Cliente criado com sucesso", clienteCriado.getId());
